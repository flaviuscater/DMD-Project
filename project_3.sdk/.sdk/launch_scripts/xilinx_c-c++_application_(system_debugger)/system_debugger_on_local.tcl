...
targets -set -nocase -filter {name =~ "microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent Zed 210248447758"} -index 1
dow F:/DMD_Projects/project_3/project_3.sdk/MB_Hello/Debug/MB_Hello.elf
